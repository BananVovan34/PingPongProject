...
{
    public class BloomIntensityController : BasePostFXController
    {
        ...
        private void Awake()
        {
            ...
            _defaultIntensity = _bloom.intensity.value;
        }
        ...
        {
            _bloom.intensity.value = _defaultIntensity + curveValue;
        }

        protected override void ResetToDefault()
        {
            _bloom.intensity.value = _defaultIntensity;
        }
    }
}